...
class Home_model{
	...
	public function getUsermenu(){
		if( isset($_SESSION['usr']) ){
			...
			$this->db->query("SELECT distinct username,menuid,menu,route,type,grouping,icon FROM v_user_menu WHERE username='$user' and type='parent'");
	...
	public function getUserMenuSetting(){
		if( isset($_SESSION['usr']) ){
			$user = $_SESSION['usr']['user'];
			$this->db->query("SELECT distinct username, menuid,menu,route,type,grouping,icon FROM v_user_menu WHERE username='$user' and type='parent' and grouping = 'setting'");
			return $this->db->resultSet();
		}
	}
