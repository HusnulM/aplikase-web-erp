                        ...
                        <div class="body">                     
                            <div class="row" style="margin-bottom:0px;">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12" style="margin-bottom:0px;">
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            <input type="date" name="servicedate" id="servicedate" class="datepicker form-control" value="<?= date('Y-m-d'); ?>">
                                        </div>
                                    </div>    
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12" style="margin-bottom:0px;">
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            <input type="text" class="form-control" name="mekanik" id="mekanik" required>
                                        </div>
                                    </div>    
                                </div>
                                ...
                                <!-- <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12" style="margin-bottom:0px;">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <label for="whsservice">Warehouse</label>
                                            <input type="text" class="form-control" name="whsservice" id="whsservice" required>
                                            <input type="hidden" class="form-control" name="whsreq" id="whsreq">
                                        </div>
                                    </div>    
                                </div> -->
