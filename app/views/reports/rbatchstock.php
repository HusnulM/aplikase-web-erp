        ...
        $(function(){
            ...
            $('#btn-process').on('click', function(){
                if($('#material').val() === "" && $('#warehouse').val() === ""){
                    window.location.href = base_url+'/reports/batchstockview';    
                }else if($('#material').val() != "" && $('#warehouse').val() === ""){
                    window.location.href = base_url+'/reports/batchstockview/'+$('#material').val()
                }else if($('#material').val() === "" && $('#warehouse').val() != ""){
                    window.location.href = base_url+'/reports/batchstockview/null/'+$('#warehouse').val();
                }
                else{
                    window.location.href = base_url+'/reports/batchstockview/'+$('#material').val()+'/'+$('#warehouse').val();
                }
